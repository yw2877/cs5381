...
# Also, let's remember to make a manifest file for deploying to posit cloud connect
# rsconnect::writeManifest(appDir = "04_deployment/positcloudconnect/shinyr", appMode = "shiny")